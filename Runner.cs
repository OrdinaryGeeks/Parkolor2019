...
public class Runner : MonoBehaviour
{
    ...
    public void ChangeCurrentWeapon(int change)
    {
        ...
        {
            CurrentWeaponText.text = equipment[currentWeaponIndex] + " " + swordAmmo;
            UnEquipGun();
            EquipSword();
        }
        if (equipment[currentWeaponIndex] == "Gun")
        {
            CurrentWeaponText.text = equipment[currentWeaponIndex] + " " + gunAmmo;
            UnEquipSword();
            EquipGun();
        }
    ...
    void Update()
    {
      ...
      //  Debug.Log(Input.GetAxis("Mouse ScrollWheel"));
        ...
        if (Input.GetAxis("Mouse ScrollWheel") > 0)
        {
          ...
          //  CurrentWeaponText.text = equipment[currentWeaponIndex % equipment.Count];
      ...
      //  Debug.Log(equipment.Count);
       // Debug.Log(currentWeaponIndex + " is cwi");
       // Debug.Log(currentWeaponIndex % equipment.Count);
      //  Debug.Log(equipment[currentWeaponIndex % equipment.Count]);
